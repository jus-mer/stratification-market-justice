...
::: {.notes}
What this model adds is, first, a distinction between perceptions and preferences, meaning between how people think society works and how they think it should work. This is represented in the upper-right corner using the same items, but with a normative sense. 
:::
...
Also, you can see the two items for each factor, all measured on a four-point Likert agreement scale.
...
Methodologically, we proceed in two steps. First, we estimate a confirmatory factor analysis of the multidimensional scale, which shows a very good fit to the data. This gives us confidence that the latent structure of the scale is empirically well supported. 
...
These results suggest that Chileans largely see privilege as more decisive than merit, even thoh effort remains the ideal they most strongly support. 
...
Perceiving society as non-meritocratic is associated with lower support for pension market justice. A possible interpretation is that seeing society as shaped by privilege rather than merit may increase awareness of inequality and reduce its justification in domains such as pensions.

By contrast, we do not find an effect for preferences for meritocracy, perhaps because this factor has little variation, as most people normatively support meritocratic principles.

Finally, the most striking result, in our view, is that stronger support for non-meritocratic ad-VAN-tij is associated with higher support for pension market justice. This is a completely new finding, and one we would be very interested to discuss with you.
