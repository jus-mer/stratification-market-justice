# Resultados {background-color="#491106ff"}
...
sjPlot::plot_model(
  m5,
  type = "est",
  terms = c("ola_num","ola_2", "egpIntermediate class (III+IV)","egpService class (I+II)","merit_effort_cwc","merit_talent_cwc", "merit_effort_mean", "merit_talent_mean"),
