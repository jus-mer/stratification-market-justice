...
cat("\n=== Distribución de NA en EGP por ola ===\n")
elsoc_long_2016_2023 <- elsoc_long_2016_2023 %>% 
...
cat("\n=== Componentes ocupacionales en casos NA de EGP ===\n")
elsoc_long_2016_2023 %>% 
  filter(is.na(egp)) %>% 
  summarise(
    total_na = n(),
...
cat("\n=== Distribución de m02 en casos NA de EGP ===\n")
...
cat("\n=== Cobertura de m02 en casos NA de EGP ===\n")
...
elsoc_long_2016_2023 <- elsoc_long_2016_2023 %>% 
  mutate(
    situacion_na_egp = case_when(
      ...
      is.na(egp) & m02 %in% c(1, 2, 3) ~ "Otra situación laboral con EGP NA",
      is.na(egp) & is.na(m02) ~ "Sin respuesta en m02",
      TRUE ~ "Otro"
    )
  )

# 6. Tabla cruzada por ola
cat("\n=== Situación laboral de casos NA en EGP por ola ===\n")
...
df_study1_wide$aget_2 <-df_study1_wide$aget_1 #age
df_study1_wide$aget_3 <-df_study1_wide$aget_1
df_study1_wide$aget_4 <-df_study1_wide$aget_1
df_study1_wide$aget_5 <-df_study1_wide$aget_1
df_study1_wide$aget_6 <-df_study1_wide$aget_1
df_study1_wide$aget_7 <-df_study1_wide$aget_1
...
df_study1_long_t7 <- df_study1_long_t7 %>%
...
df_study1_long_t7 <- df_study1_long_t7 %>% filter(n_participaciones>1)
```
