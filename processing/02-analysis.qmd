...
ccoef <- list(
  ...
  "egpOut of labor force" = "Out of labor force",
...
ccoef <- list(
  ...
  "egpOut of labor force:merit_effort_cwc" = "Out of labor force x Merit: Effort (WE)",
  ...
  "egpOut of labor force:merit_talent_cwc" = "Out of labor force x Merit: Talent (WE)",
  ...
  "egpOut of labor force:merit_effort_mean" = "Out of labor force x Merit: Effort (BE)",
  ...
  "egpOut of labor force:merit_talent_mean" = "Out of labor force x Merit: Talent (BE)")
...
# m13 <- clmm(just_pension ~ 1 + ola_num + egp + merit_effort_cwc + merit_talent_cwc + merit_effort_mean + merit_talent_mean + ideo + sex + age + egp*merit_effort_mean + (1 + ola_num | idencuesta), 
#            link = "logit",
#  Hess = TRUE,
#           data = df_study1)

# m14 <- clmm(just_pension ~ 1 + ola_num + egp + merit_effort_cwc + merit_talent_cwc + merit_effort_mean + merit_talent_mean + ideo + sex + age + egp*merit_talent_mean + (1 + ola_num | idencuesta), 
#            link = "logit",
#  Hess = TRUE,
#           data = df_study1)
